...
export const SideBar = ()=>{
    ...
    return(
        <div className="Side-div flex items-center justify-center sm:items-end h-screen border-2 ">
            ...
            <div className={`div-left shrink-0 shadow-xl h-full bg-white w-fit lg:w-75 lg:flex gap-10 lg:flex-col justify-start items-center lg:items-start absolute top-0 left-0 lg:static text-black p-3  transition-all duration-300 ease-in-out lg:translate-x-0 -translate-x-96 ${open && "translate-x-0 flex flex-col gap-10 w-75 items-center"}`}>
                ...
                <div className="logo flex gap-25 items-center justify-center p-2">
                    ...
                    <i class="ri-close-line text-2xl font-bold lg:hidden" onClick={()=>{setOpen(false)}}></i>
                </div>
            ...
            {/* right box */}
            <div className="div-right h-full lg:max-h-150 p-4 w-fit sm:w-[calc(100%-300px)] bg-white text-black flex flex-col items-center gap-10 lg:flex-row box-border justify-center">
                {/* Hey! */}
